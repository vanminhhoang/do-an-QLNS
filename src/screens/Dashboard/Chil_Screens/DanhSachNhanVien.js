...
function DSNhanVien(props) {
    ...
    const GET_ALL_NHANVIEN =
        'https://qlnscloud.herokuapp.com/account/allNhanVien'
    const DEL_NHANVIEN =
    ...
    const URL_UPDATE_NHANVIEN =
        'https://qlnscloud.herokuapp.com/truongphong/CapNhatNhanVien'

    const URL_CREATE_NHANVIEN = 'https://qlnscloud.herokuapp.com/account/create'
